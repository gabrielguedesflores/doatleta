...
<body>
    ...
    <p class="fs-1">Atualização de estoque</p>
        ...
        if(move_uploaded_file($_FILES['fileToUpload']['tmp_name'], $target_file)) {
            ...
            echo "<p class='fs-4'>Clique no botão abaixo para atualizar o estoque. </p><br><br>";
            echo "<button type='button'><a href='../estoque/atualiza_estoque.php'>Atualizar o estoque</a></button>";
        }else{
